...
let build = gulp.series(cleanDist, gulp.parallel(html, js, css, images, fonts)),
    watch = gulp.parallel(watchFiles, build, browserSync);
...
// Fonts
// для автоматического подключения шрифтов в css создай файл "fonts.scss" в папочке "scss", в файле "style.scss" напиши:
...
// в галп файле после таска "svgsprite" вставь функцию ниже:
